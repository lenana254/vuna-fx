# Week 7 — Defining Your ONE Setup
...
1. Ask her: *"If you had to teach me only one setup, what would it be?"* Use that.
...
SESSION: _______ (e.g., London open, 08:00-11:00 Dublin time)
...
3. Have your trainer review the 20 examples. How many does she agree are valid? How many does she reject as false signals?

## Trainer check-in topics
- Her answer to: "If I only trade this one setup, what's the realistic win rate I should expect?"
